                                    ...
                                    <div className="col-xs-12 col-sm-12 col-md-12 text-left">
                                        <div className="receipt-right">
                                            <h5 className="margin-top-10">
                                                Blossom Flower Marketplace<span className="text-warning">.</span>
                                            </h5>
                                            <p>
                                                <i className="fa fa-phone" /> 852 - 9888 9791
                                            </p>
                                            <p>
                                                <i className="fa fa-envelope" /> blossomflower@gmail.com
                                            </p>
                                            <p>
                                                <i className="fa fa-location-arrow" /> No.8 Tai Street, Tsuen Wan, Hong Kong
                                            </p>
                                        </div>
                                    </div>
                                </div>
