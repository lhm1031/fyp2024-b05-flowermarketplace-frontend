                                        ...
                                        {orders?.map((o, index) => (
                                            <tr key={index}>
                                                <td>
                                                    ...
                                                    <p className="text-muted mb-0">{moment(o.date).format('DD MMM, YYYY')}</p>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <Link to={`/customer/orders/${o.oid}/`} className="btn btn-link btn-sm btn-rounded" >
                                                        View <i className="fas fa-eye" />
                                                    </Link>

                                                    <Link to={`/customer/invoice/${o.oid}/`} className="btn btn-link btn-sm btn-rounded" >
