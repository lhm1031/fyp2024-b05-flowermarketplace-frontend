                          ...
                          {status === "Verifying" &&
                              ...
                              <div className="card bg-white shadow p-5">
                                ...
                                <div className="text-center">
                                  ...
                                  <p>
                                      <b className='text-success'>Please hold on, while we varify your payment</b>
                                      <br />
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="modal-body text-start text-black p-4">
                ...
                <hr
                  className="mt-2 mb-4"
                  style={{height: 0, backgroundColor: "transparent", opacity: ".75", borderTop: "2px dashed #9e9e9e"}}
                />
                {order.orderitems?.map((o, index) => (
                    <div className="d-flex justify-content-between shadow p-2 rounded-2 mb-2">
                        ...
                        <p className="text-muted mb-0">{o.qty}</p>
